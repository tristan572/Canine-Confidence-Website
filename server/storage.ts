  ...
  private seedData() {
    ...
    const packageData: InsertPackage[] = [
      ...
      },
      {
        ...
        description: "Your reliable, budget-friendly solution for essential well-being.\n\nThis five-session package guarantees your dog receives consistent exercise, stimulation, and fun, all delivered right to your doorstep by my professional dog handlers. It's the simplest way to ensure a happy, active dog, even on your busiest days.\n\n**What the 5x Commitment Delivers:**\n\n**Reliable, Consistent Care:** By committing to five sessions, you establish a consistent routine that your dog can count on. This regularity is key to reducing stress and maintaining good manners throughout the week.\n\n**Structured Enrichment Walks:** My walks are more than just a stroll. I ensure your dog gets plenty of essential sniffing time (mental stimulation) and attentive care, making every outing a fulfilling experience that leaves your pet content.\n\n**Ultimate Convenience & Simplicity:** My professional handlers come directly to your home, ensuring your pet enjoys a healthy walk and essential exercise without you having to be present. It's the perfect helping hand for busy schedules.\n\n**Budget-Friendly Value:** This package offers the most convenient and reliable service while providing savings compared to booking single sessions.",
        price: "$215",
        originalPrice: "$225",
        duration: "5 sessions",
        sessions: 5,
