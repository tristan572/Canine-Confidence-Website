            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-medium-grey leading-relaxed">
                  Professional dog training in Brisbane, where trust, play, and clear communication build stronger bonds. We help you create lasting behavioural foundations using modern methods that fulfill your dog's instincts and bring balance to your home.
                </p>
              </div>
