...
## Short ad cut (about 18 seconds)

`canine-confidence-cartoon-15s.mp4` is the short ad cut, about 18 seconds, 9:16, for paid ads and Stories. It's built from the same scenes:
...
| 9–12.5s | Cleo peeks over the five-star review card, then "100+ five-star reviews" |
| 12.5–18.4s | Logo, "Build the blocks. Live the balance.", book an Initial Canine Success Assessment, website and phone |
